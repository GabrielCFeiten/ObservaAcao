/* profile.js — componente global de cabeçalho + dropdown de perfil.
   Toda página autenticada chama renderHeader({ links, active }). */
    ...
    <div class="container header-inner">
      ...
      <div class="profile-wrap">
        ...
        <div class="profile-menu" id="profileMenu" role="menu">
          ...
          <button id="menuSettings" role="menuitem">Configurações</button>
...
function wireSettingsModal() {
  ...
  // Ao abrir, carrega os dados atuais do próprio usuário.
