...
public class UsuarioService implements UserDetailsService {
    ...
    public UsuarioModel cadastrar(CadastroUsuarioDTO dto) {
        ...
        // Quem se cadastra pela API pública é SEMPRE CIDADAO
    ...
    /**
     * Apenas GESTOR pode alterar o tipo de outro usuário.
     * Um GESTOR pode promover CIDADAO para GESTOR ou rebaixar GESTOR para CIDADAO.
     * Não é permitido alterar para ANONIMO.
     */
    ...
    /** Edição do próprio perfil. Só altera campos enviados (não nulos/vazios). */
    ...
    /** Lista todos os administradores (GESTOR) cadastrados. */
